package com.arcsoft.example.httpUntil;
...
public class HttpUtilsUser {
    //private static String PATH = "http://192.168.2.109:8080/user";
    //private static URL url;

    public HttpUtilsUser() {
    }
   /* static {
        try {
            url = new URL(PATH);
...
//            System.out.println(buffer.toString());
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                //System.out.println("connection.getInputStream()：：：："+connection.getInputStream()+", encode：：：：："+encode);
