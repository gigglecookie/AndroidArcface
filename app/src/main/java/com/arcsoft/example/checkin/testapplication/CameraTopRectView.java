...
//    private static final int BOTTOM_BTN_HEIGHT = Constant.RECT_VIEW_BOTTOM;
    ...
    private static final String TIPS = "请注视镜头";
    ...
    public CameraTopRectView(Context context, AttributeSet attrs) {
     ...
     //   viewHeight = panelHeght - (int) DisplayUtil.dp2px(activity,TOP_BAR_HEIGHT + BOTTOM_BTN_HEIGHT)*2;
        ...
        //设置图片大小
        //rectWidth = panelWidth - (int) DisplayUtil.dp2px(activity,LEFT_PADDING + RIGHT_PADDING)-96;
        //rectHeght = (int) (rectWidth * 20 / 19);
        rectWidth = panelWidth - (int) DisplayUtil.dp2px(activity,LEFT_PADDING + RIGHT_PADDING)-88;
        rectHeght = (int) (rectWidth * 2 /1.79 );
        System.out.println(rectHeght+"rectHight::::::::::"+"rectwidth：：：：：："+":::::::"+rectWidth+":::::::::::::::::::::::::");
        // 相对于此view
        ...
        baseline = rect.top + (rect.bottom - rect.top - fontMetrics.bottom + fontMetrics.top)  - fontMetrics.top;
