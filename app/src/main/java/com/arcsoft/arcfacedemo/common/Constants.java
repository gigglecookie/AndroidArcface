...
public class Constants {
    ...
    public static final String APP_ID = "C7W2pm2oB4rjfBeznkvxabqh3DiSDENEcmUBfTo7oTNc";
    public static final String SDK_KEY = "4NMdE8sSP9SKjMaVVjGJV5Mmd9hfrtRRkhuG9N3DyXT3";
